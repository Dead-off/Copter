...
public class GPIOCopterController implements CopterController {
...
//    можно тогда добавить getter в интерфейс, который будет отдавать текущее состояние мотора (крутится/нет)
